...
function createOnlineVisitorsCounterElement()
{
    ...
    if (existingElement === null) // Only creates a new element if does not exist yet.
    {
        ...
        //     return false;
        // };
        button.style.cssText = 'z-index:100; position: fixed; bottom: 15px; left: 10px; background-color:transparent; display:inline-block; cursor:pointer; color:#24827d; font-family:Trebuchet MS; font-size:14px; padding:3px 7px; text-decoration:none;' +
            'border:none; outline: none;background-image: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%);border-bottom-right-radius: 14px;';
