...
<style type="text/css">
   ...
   <span style="width: 50%;">
      ...
      <table class="table-responsive table-borderless table-sm">
         ...
         <tr>
            <th id="trr" class="trr">
               <span><img src="/images/counter.gif" width="16" height="16" border="0" /> Visitors Statistics</span>
            </th>
            <th id="tr">Today</th>
            <th id="tr">Yesterday</th>
            <th id="tr">Week</th>
            <th id="tr">Month</th>
            <th id="tr">Month</th>
            <th id="tr">Total</th>
         ...
         <tr>
            <td>
               <span style="font-size:75%;">Record: {{ $record }} ({{ date("d.m.Y", $record_time) }})</span>
            </td>
            <td>{{ $online }}</td>
            <td>{{ $yesterday }}</td>
            <td>{{ $week }}</td>
...
{{-- <span><a href="#"><img src="https://worldflagcounter.com/ewd/" alt="Flag Counter" style="width: 50% !important; height: 77px !important;"></a></span> --}}


{{--<div class="container">--}}
   {{--<div style="width:10%;display: block;">--}}
      {{--<div style="border:1px solid #000000;padding:2px;width:100%;font-size:80%;font-weight:bold;">--}}
         {{--<img src="/images/counter.gif" width="16" height="16" border="0" /> Visitor Statistics--}}
      {{--</div>--}}
      ...
      {{--<div style="border:1px solid #000000;padding:2px;width:100%;font-size:80%;">--}}
         {{--Record: {{ $record }} ({{ date("d.m.Y", $record_time) }})--}}
